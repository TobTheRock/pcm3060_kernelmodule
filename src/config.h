...
#define CONFIG_ADC_CLOCK_BCK1_F_HZ ((CONFIG_ADC_FS_HZ)*(CONFIG_ADC_RATIO_SCK1_FS_HZ))  // ADC BCK clock speed in Hz
#define CONFIG_ADC_CLOCK_LRCK1_F_HZ ((CONFIG_ADC_RATIO_BCK1_LRCK_HZ)*(CONFIG_ADC_CLOCK_BCK1_F_HZ))
...
#define CONFIG_DAC_CLOCK_BCK2_F_HZ ((CONFIG_DAC_FS_HZ)*(CONFIG_DAC_RATIO_SCK2_FS_HZ))  // DAC BCK clock speed in Hz
#define CONFIG_DAC_CLOCK_LRCK2_F_HZ ((CONFIG_DAC_RATIO_BCK2_LRCK_HZ)*(CONFIG_DAC_CLOCK_BCK2_F_HZ))


/*-------------------------------- Treansceiver Settings ------------------------------------*/
#define CONFIG_WORD_SIZE_PER_TX 20
